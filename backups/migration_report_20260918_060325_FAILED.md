...

{
  ...
  "errors": [
    "duplicate key value violates unique constraint \"greedy_rounds_pkey\"\nDETAIL:  Key (id)=(104) already exists.\n"
  ],
  "mysql_counts": {
    "users": 690,
    "coin_packages": 18,
...
UniqueViolation('duplicate key value violates unique constraint "greedy_rounds_pkey"\nDETAIL:  Key (id)=(104) already exists.\n')